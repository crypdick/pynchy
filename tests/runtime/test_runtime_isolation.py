...
def test_second_runtime_has_its_own_database_and_docker_namespace(tmp_path: Path) -> None:
    ...
    try:
        setup = subprocess.run(  # noqa: S603 - fixed harness command with a test-owned checkout.
        ...
        stop = subprocess.run(  # noqa: S603 - fixed harness cleanup for the test-owned checkout.
            [  # noqa: S607 - uv is the repository's required Python runner.
                "uv",
                "run",
                "python",
