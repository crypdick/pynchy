...
Install Pynchy on a local macOS or Linux machine, or deploy it on a headless
Linux server.
...
After installation, configure [Channels](../channels/index.md), [Integrations](../integrations/index.md),
and [Usage](../usage/index.md) for the way you work.
