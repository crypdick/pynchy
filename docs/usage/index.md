...
that completed before Pynchy received the command. System notices and automated
provider events do not post into or resume the frozen thread. A direct message
or provider-authenticated human comment resumes it.
