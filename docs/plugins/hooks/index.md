...
| Category | Hooks |
|----------|-------|
| [Agent cores and lifecycle hooks](agent-cores.md) | `pynchy_agent_core_info`, `pynchy_agent_hook_specs`, `pynchy_before_context_reset` |
...
| [Observers](observers.md) | `pynchy_observer` |
