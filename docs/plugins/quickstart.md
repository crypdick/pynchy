...
!!! tip
    The `cookiecutter-pynchy-plugin` repository provides a ready-made template for this structure. Use it if you want a generated starter project with optional hook scaffolding.
