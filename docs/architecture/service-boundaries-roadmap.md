...
|---|---:|---|
| `application` | 166 | `canary_adapter` 2, `config` 55, `container_adapter` 37, `git_adapter` 13, `host_adapter` 1, `integration_adapter` 2, `learning_adapter` 6, `state_adapter` 40, `temporal_adapter` 10 |
