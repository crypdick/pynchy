...
# Build: docker build -t pynchy-mcp-notebook -f src/pynchy/agent/mcp/notebook.Dockerfile src/pynchy/plugins/integrations
...
COPY notebook_server /app/notebook_server
