...
import json
import shutil
import subprocess  # noqa: S404 - tunnel detection uses fixed no-shell tailscale argv.
    ...
    def _fetch(self) -> None:
        ...
        try:
            result = subprocess.run(
                ["tailscale", "status", "--json"],  # noqa: S607 - tailscale is a trusted host CLI and argv is fixed.
                capture_output=True,
                text=True,
                timeout=5,
                check=False,
