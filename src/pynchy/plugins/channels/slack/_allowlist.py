...
class SlackAllowlist:
    ...
    async def _ensure_joined(self, channel_id: str, name: str) -> None:
        ...
        except Exception as exc:  # noqa: BLE001 - Slack API join failures are best-effort for optional channels.
            logger.debug(
    ...
    async def create_group(self, name: str) -> str:
        ...
        try:
            ...
            Exception
        ) as exc:  # Slack channel creation/reuse is a best-effort integration boundary.
            ...
            try:
                await app.client.conversations_join(channel=channel_id)
            except Exception as join_exc:  # noqa: BLE001 - join retry is optional after name_taken reuse.
                logger.warning(
