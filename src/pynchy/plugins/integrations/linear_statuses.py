...
LINEAR_TODO_STATUSES: dict[str, TodoStatusSpec] = {
    ...
    AWAITING_PLAN_APPROVAL_STATUS: TodoStatusSpec(
        "Awaiting Plan Approval", "unstarted", 30.0, "#BB6BD9"
    ),
    ...
    AWAITING_REVIEW_STATUS: TodoStatusSpec("Awaiting Review", "started", 60.0, "#5E6AD2"),
    FOLLOW_UPS_STATUS: TodoStatusSpec("Follow-ups", "started", 70.0, "#F2994A"),
    "blocked": TodoStatusSpec("Blocked", "started", 80.0, "#EB5757"),
    "done": TodoStatusSpec("Done", "completed", 90.0, "#27AE60"),
    "rejected": TodoStatusSpec("Rejected", "canceled", 100.0, "#6B7280"),
}
