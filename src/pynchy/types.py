...
class MatrixRouteDefaults(Protocol):
    """Connection defaults inherited by a resolved Matrix route."""
...
class MatrixEndpoint(Protocol):
    """Validated Matrix room fields used by route resolution and delivery."""
...
class MatrixConnection(Protocol):
    """Validated Matrix connection fields consumed by its adapter."""
