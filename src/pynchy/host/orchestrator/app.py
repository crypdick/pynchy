...
def _scheduler_runtime_config(settings: Settings) -> SchedulerRuntimeConfig:
    ...
    return SchedulerRuntimeConfig(
        ...
        audit_lookback_days=settings.scheduler.audit_lookback_days,
        evidence_retention_days=settings.scheduler.evidence_retention_days,
        missed_occurrence_grace_seconds=settings.scheduler.missed_occurrence_grace_seconds,
